...
class MailtemplateController extends Controller
{
	...
	{
		return array(
			array('allow', // allow admin user to perform 'index', 'view', 'admin', 'create', 'update' and 'delete' actions
	...
	public function actionIndex()
	{
      ...
      'found'=> MailTemplate::model()->findMissingAndExceeding(),
      'required'=> MailTemplate::model()->listRequired(),
		));
	}
