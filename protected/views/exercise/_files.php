...
<?php if($filesInfo['unchecked']): ?><?php echo CHtml::link($this->createIcon('new', Yii::t('swu', 'There is one file to check.|There are {n} files to check.', $filesInfo['unchecked'])), array('exercise/view', 'id'=>$exercise->id)) ?><?php endif ?>
